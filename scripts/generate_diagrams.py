"""
Visual diagrams for project documentation.

Generate diagrams showing:
1. Data flow pipeline
2. Etymology chain structure
...
if __name__ == "__main__":
    ...
    output_path = Path("docs/architecture_diagrams.md")
    output_path.parent.mkdir(exist_ok=True)
    
    with open(output_path, 'w', encoding='utf-8') as f:
        f.write(diagram)
    
    print(f"✓ Created diagrams: {output_path}")
